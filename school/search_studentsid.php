        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Search Student(SID)</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Search Form By Student</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                <form role="form" method="post" action="search_studentsid.php">
                <div class="card-body">
                  <div class="form-group">
                    <label for="User Name">Enter StudentID</label>
...
<?php if(isset($_POST["submit"]))
{
   ...
   {       
    ...
    {
        $error[]='<div class="col-md-6"><div class="alert alert-warning alert-dismissible"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                   <h5><i class="icon fa fa-warning"></i> Alert!</h5>StudentID not exists or not register in Student form.</div></div>';
